...
export const suggestions: OpinionCardT[] = [
	{
		user: {
			firstName: "Name 1",
			lastName: "Example",
...
export const ratings: OpinionCardT[] = [
	{
		user: {
			firstName: "Name 1",
			lastName: "Example",
...
export const ratingsForTesting: OpinionCardT[] = [
	{
		user: {
			firstName: "Name 5",
			lastName: "Example",
...
export const suggestionsForTesting: OpinionCardT[] = [
	{
		user: {
			firstName: "Name 5",
			lastName: "Example",
